...
var MenubarToggle = function (_BaseMenuToggle) {
  ...
  _createClass$4(MenubarToggle, [{
    ...
    value: function open() {
      this.closeSiblings();
      _get$2(_getPrototypeOf$4(MenubarToggle.prototype), "open", this).call(this);
    }
  }, {
    key: "preview",
    value: function preview() {
      this.closeSiblings();
      _get$2(_getPrototypeOf$4(MenubarToggle.prototype), "preview", this).call(this);
    }
  }, {
    key: "close",
    value: function close() {
      ...
      _get$2(_getPrototypeOf$4(MenubarToggle.prototype), "close", this).call(this);
    }
  }]);
...
var Menubar = function (_BaseMenu) {
  ...
  function Menubar(_ref) {
    ...
    _defineProperty$2(_assertThisInitialized$3(_this), "_MenuType", Menubar);
    _defineProperty$2(_assertThisInitialized$3(_this), "_MenuItemType", MenubarItem);
    _defineProperty$2(_assertThisInitialized$3(_this), "_MenuToggleType", MenubarToggle);
    if (initialize) {
      _this.initialize();
    }
    return _this;
  ...
  _createClass$3(Menubar, [{
    ...
    value: function _handleKeydown() {
      var _this3 = this;
      _get$1(_getPrototypeOf$3(Menubar.prototype), "_handleKeydown", this).call(this);
    ...
    value: function _handleKeyup() {
      var _this4 = this;
      _get$1(_getPrototypeOf$3(Menubar.prototype), "_handleKeyup", this).call(this);
...
var Bootstrap4MenubarItem = function (_MenubarItem) {
  _inherits$2(Bootstrap4MenubarItem, _MenubarItem);
  var _super = _createSuper$2(Bootstrap4MenubarItem);
  function Bootstrap4MenubarItem(_ref) {
    ...
    var menuItemElement = _ref.menuItemElement,
        ...
        _ref$initialize = _ref.initialize,
        initialize = _ref$initialize === void 0 ? true : _ref$initialize;
    _classCallCheck$2(this, Bootstrap4MenubarItem);
    _this = _super.call(this, {
      menuItemElement: menuItemElement,
      menuLinkElement: menuLinkElement,
      parentMenu: parentMenu,
  ...
  return _createClass$2(Bootstrap4MenubarItem);
}(MenubarItem);
...
var Bootstrap4MenubarToggle = function (_MenubarToggle) {
  _inherits$1(Bootstrap4MenubarToggle, _MenubarToggle);
  var _super = _createSuper$1(Bootstrap4MenubarToggle);
  function Bootstrap4MenubarToggle(_ref) {
    ...
    var menuToggleElement = _ref.menuToggleElement,
        ...
        _ref$initialize = _ref.initialize,
        initialize = _ref$initialize === void 0 ? true : _ref$initialize;
    _classCallCheck$1(this, Bootstrap4MenubarToggle);
    _this = _super.call(this, {
      menuToggleElement: menuToggleElement,
      parentElement: parentElement,
      controlledMenu: controlledMenu,
  ...
  _createClass$1(Bootstrap4MenubarToggle, [{
    key: "initialize",
    value: function initialize() {
      _get(_getPrototypeOf$1(Bootstrap4MenubarToggle.prototype), "initialize", this).call(this);
...
var Bootstrap4Menubar = function (_Menubar) {
  _inherits(Bootstrap4Menubar, _Menubar);
  var _super = _createSuper(Bootstrap4Menubar);
  function Bootstrap4Menubar(_ref) {
    ...
    var menuElement = _ref.menuElement,
        ...
        _ref$initialize = _ref.initialize,
        initialize = _ref$initialize === void 0 ? true : _ref$initialize;
    _classCallCheck(this, Bootstrap4Menubar);
    _this = _super.call(this, {
      menuElement: menuElement,
      menuItemSelector: menuItemSelector,
      menuLinkSelector: menuLinkSelector,
    ...
    _defineProperty(_assertThisInitialized(_this), "_MenuType", Bootstrap4Menubar);
    _defineProperty(_assertThisInitialized(_this), "_MenuItemType", Bootstrap4MenubarItem);
    _defineProperty(_assertThisInitialized(_this), "_MenuToggleType", Bootstrap4MenubarToggle);
    if (initialize) {
      _this.initialize();
    }
    return _this;
  }
  return _createClass(Bootstrap4Menubar);
}(Menubar);

export { Bootstrap4Menubar as default };
//# sourceMappingURL=menubar-bs4.esm.js.map
