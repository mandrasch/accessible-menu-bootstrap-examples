var AccessibleMenuBootstrap4 = (function () {
  ...
  function isValidInstance(contructor, elements) {
    try {
      if (_typeof$i(elements) !== "object") {
        var elementsType = _typeof$i(elements);
      ...
      for (var key in elements) {
        if (!(elements[key] instanceof contructor)) {
          var elementType = _typeof$i(elements[key]);
  ...
  function _toConsumableArray$5(arr) { return _arrayWithoutHoles$5(arr) || _iterableToArray$5(arr) || _unsupportedIterableToArray$5(arr) || _nonIterableSpread$5(); }
  ...
  var BaseMenuToggle = function () {
    function BaseMenuToggle(_ref) {
      ...
      _classCallCheck$k(this, BaseMenuToggle);
      _defineProperty$b(this, "_dom", {
        toggle: null,
        parent: null
      });
      _defineProperty$b(this, "_elements", {
        controlledMenu: null,
        parentMenu: null
      });
      _defineProperty$b(this, "_open", false);
      _defineProperty$b(this, "_expandEvent", new CustomEvent("accessibleMenuExpand", {
        bubbles: true,
        detail: {
          toggle: this
        }
      }));
      _defineProperty$b(this, "_collapseEvent", new CustomEvent("accessibleMenuCollapse", {
        bubbles: true,
        detail: {
          toggle: this
        }
      ...
      value: function _expand() {
        ...
        if (openClass !== "") {
          if (typeof openClass === "string") {
            ...
            (_this$elements$contro2 = this.elements.controlledMenu.dom.menu.classList).add.apply(_this$elements$contro2, _toConsumableArray$5(openClass));
          }
        }
        if (closeClass !== "") {
          if (typeof closeClass === "string") {
            ...
            (_this$elements$contro3 = this.elements.controlledMenu.dom.menu.classList).remove.apply(_this$elements$contro3, _toConsumableArray$5(closeClass));
          }
        }
        if (emit) {
      ...
      value: function _collapse() {
        ...
        if (closeClass !== "") {
          if (typeof closeClass === "string") {
            ...
            (_this$elements$contro5 = this.elements.controlledMenu.dom.menu.classList).add.apply(_this$elements$contro5, _toConsumableArray$5(closeClass));
          }
        }
        if (openClass !== "") {
          if (typeof openClass === "string") {
            ...
            (_this$elements$contro6 = this.elements.controlledMenu.dom.menu.classList).remove.apply(_this$elements$contro6, _toConsumableArray$5(openClass));
          }
        }
        if (emit) {
  ...
  var BaseMenuItem = function () {
    function BaseMenuItem(_ref) {
      ...
      _classCallCheck$j(this, BaseMenuItem);
      _defineProperty$a(this, "_dom", {
        item: null,
        link: null
      });
      _defineProperty$a(this, "_elements", {
        parentMenu: null,
        childMenu: null,
        toggle: null
      });
      _defineProperty$a(this, "_submenu", false);
  ...
  var BaseMenu = function () {
    function BaseMenu(_ref) {
      ...
      _classCallCheck$i(this, BaseMenu);
      _defineProperty$9(this, "_MenuType", BaseMenu);
      _defineProperty$9(this, "_MenuItemType", BaseMenuItem);
      _defineProperty$9(this, "_MenuToggleType", BaseMenuToggle);
      _defineProperty$9(this, "_dom", {
        menu: null,
        menuItems: [],
        submenuItems: [],
        submenuToggles: [],
      ...
      _defineProperty$9(this, "_elements", {
        menuItems: [],
        submenuToggles: [],
        controller: null,
        parentMenu: null,
      ...
      _defineProperty$9(this, "_openClass", "show");
      _defineProperty$9(this, "_closeClass", "hide");
      _defineProperty$9(this, "_root", true);
      _defineProperty$9(this, "_currentChild", 0);
      _defineProperty$9(this, "_focusState", "none");
      _defineProperty$9(this, "_currentEvent", "none");
      _defineProperty$9(this, "_hoverType", "off");
      _defineProperty$9(this, "_hoverDelay", 250);
      ...
      value: function _setDOMElementType(elementType) {
        ...
        if (typeof this.selectors[elementType] === "string") {
          ...
          if (overwrite) {
            ...
            this._dom[elementType] = [].concat(_toConsumableArray$4(this._dom[elementType]), _toConsumableArray$4(filteredElements));
          }
        } else {
  ...
  function _possibleConstructorReturn$h(self, call) { if (call && (_typeof$h(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return _assertThisInitialized$h(self); }
  ...
  var DisclosureMenuItem = function (_BaseMenuItem) {
    _inherits$h(DisclosureMenuItem, _BaseMenuItem);
    var _super = _createSuper$h(DisclosureMenuItem);
    function DisclosureMenuItem(_ref) {
      ...
      _classCallCheck$h(this, DisclosureMenuItem);
    ...
    return _createClass$h(DisclosureMenuItem);
  }(BaseMenuItem);
  ...
  function _get$9() { if (typeof Reflect !== "undefined" && Reflect.get) { _get$9 = Reflect.get; } else { _get$9 = function _get(target, property, receiver) { var base = _superPropBase$9(target, property); if (!base) return; var desc = Object.getOwnPropertyDescriptor(base, property); if (desc.get) { return desc.get.call(arguments.length < 3 ? target : receiver); } return desc.value; }; } return _get$9.apply(this, arguments); }
  function _superPropBase$9(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf$g(object); if (object === null) break; } return object; }
  ...
  function _possibleConstructorReturn$g(self, call) { if (call && (_typeof$g(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return _assertThisInitialized$g(self); }
  ...
  var DisclosureMenuToggle = function (_BaseMenuToggle) {
    _inherits$g(DisclosureMenuToggle, _BaseMenuToggle);
    var _super = _createSuper$g(DisclosureMenuToggle);
    function DisclosureMenuToggle(_ref) {
      ...
      var menuToggleElement = _ref.menuToggleElement,
          ...
          _ref$initialize = _ref.initialize,
          initialize = _ref$initialize === void 0 ? true : _ref$initialize;
      _classCallCheck$g(this, DisclosureMenuToggle);
      _this = _super.call(this, {
    ...
    _createClass$g(DisclosureMenuToggle, [{
      key: "open",
      value: function open() {
        this.closeSiblings();
        _get$9(_getPrototypeOf$g(DisclosureMenuToggle.prototype), "open", this).call(this);
      }
    }, {
      key: "preview",
      value: function preview() {
        this.closeSiblings();
        _get$9(_getPrototypeOf$g(DisclosureMenuToggle.prototype), "preview", this).call(this);
      }
    }, {
      key: "close",
      value: function close() {
        ...
        _get$9(_getPrototypeOf$g(DisclosureMenuToggle.prototype), "close", this).call(this);
      }
    }]);
  ...
  function _superPropBase$8(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf$f(object); if (object === null) break; } return object; }
  ...
  function _possibleConstructorReturn$f(self, call) { if (call && (_typeof$f(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return _assertThisInitialized$f(self); }
  ...
  var DisclosureMenu = function (_BaseMenu) {
    _inherits$f(DisclosureMenu, _BaseMenu);
    var _super = _createSuper$f(DisclosureMenu);
    function DisclosureMenu(_ref) {
      ...
      var menuElement = _ref.menuElement,
          ...
          _ref$initialize = _ref.initialize,
          initialize = _ref$initialize === void 0 ? true : _ref$initialize;
      _classCallCheck$f(this, DisclosureMenu);
      _this = _super.call(this, {
      ...
      _defineProperty$8(_assertThisInitialized$f(_this), "_MenuType", DisclosureMenu);
      _defineProperty$8(_assertThisInitialized$f(_this), "_MenuItemType", DisclosureMenuItem);
      _defineProperty$8(_assertThisInitialized$f(_this), "_MenuToggleType", DisclosureMenuToggle);
      _defineProperty$8(_assertThisInitialized$f(_this), "_currentChild", -1);
      _defineProperty$8(_assertThisInitialized$f(_this), "_optionalSupport", false);
    ...
    _createClass$f(DisclosureMenu, [{
      key: "initialize",
      value: function initialize() {
        try {
          _get$8(_getPrototypeOf$f(DisclosureMenu.prototype), "initialize", this).call(this);
          this._handleFocus();
          this._handleClick();
          this._handleHover();
          this._handleKeydown();
      ...
      key: "_validate",
      value: function _validate() {
        var check = _get$8(_getPrototypeOf$f(DisclosureMenu.prototype), "_validate", this).call(this);
        if (!isValidType("boolean", {
      ...
      value: function _handleClick() {
        var _this2 = this;
        _get$8(_getPrototypeOf$f(DisclosureMenu.prototype), "_handleClick", this).call(this);
      ...
      value: function _handleKeydown() {
        var _this3 = this;
        _get$8(_getPrototypeOf$f(DisclosureMenu.prototype), "_handleKeydown", this).call(this);
      ...
      value: function _handleKeyup() {
        var _this4 = this;
        _get$8(_getPrototypeOf$f(DisclosureMenu.prototype), "_handleKeyup", this).call(this);
  ...
  var Bootstrap4DisclosureMenuItem = function (_DisclosureMenuItem) {
    _inherits$e(Bootstrap4DisclosureMenuItem, _DisclosureMenuItem);
    var _super = _createSuper$e(Bootstrap4DisclosureMenuItem);
    function Bootstrap4DisclosureMenuItem(_ref) {
      ...
      var menuItemElement = _ref.menuItemElement,
          ...
          _ref$initialize = _ref.initialize,
          initialize = _ref$initialize === void 0 ? true : _ref$initialize;
      _classCallCheck$e(this, Bootstrap4DisclosureMenuItem);
      _this = _super.call(this, {
        menuItemElement: menuItemElement,
        menuLinkElement: menuLinkElement,
        parentMenu: parentMenu,
    ...
    return _createClass$e(Bootstrap4DisclosureMenuItem);
  }(DisclosureMenuItem);
  ...
  function _superPropBase$7(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf$d(object); if (object === null) break; } return object; }
  ...
  var Bootstrap4DisclosureMenuToggle = function (_DisclosureMenuToggle) {
    _inherits$d(Bootstrap4DisclosureMenuToggle, _DisclosureMenuToggle);
    var _super = _createSuper$d(Bootstrap4DisclosureMenuToggle);
    function Bootstrap4DisclosureMenuToggle(_ref) {
      ...
      var menuToggleElement = _ref.menuToggleElement,
          ...
          _ref$initialize = _ref.initialize,
          initialize = _ref$initialize === void 0 ? true : _ref$initialize;
      _classCallCheck$d(this, Bootstrap4DisclosureMenuToggle);
      _this = _super.call(this, {
        menuToggleElement: menuToggleElement,
        parentElement: parentElement,
        controlledMenu: controlledMenu,
      ...
      _defineProperty$7(_assertThisInitialized$d(_this), "_dom", {
        toggle: null,
        parent: null,
        container: null
      });
    ...
    _createClass$d(Bootstrap4DisclosureMenuToggle, [{
      key: "initialize",
      value: function initialize() {
        _get$7(_getPrototypeOf$d(Bootstrap4DisclosureMenuToggle.prototype), "initialize", this).call(this);
  ...
  function _possibleConstructorReturn$c(self, call) { if (call && (_typeof$c(call) === "object" || typeof call === "function")) { return call; } else if (call !== void 0) { throw new TypeError("Derived constructors may only return object or undefined"); } return _assertThisInitialized$c(self); }
  ...
  var Bootstrap4DisclosureMenu = function (_DisclosureMenu) {
    _inherits$c(Bootstrap4DisclosureMenu, _DisclosureMenu);
    var _super = _createSuper$c(Bootstrap4DisclosureMenu);
    function Bootstrap4DisclosureMenu(_ref) {
      ...
      var menuElement = _ref.menuElement,
          ...
          _ref$initialize = _ref.initialize,
          initialize = _ref$initialize === void 0 ? true : _ref$initialize;
      _classCallCheck$c(this, Bootstrap4DisclosureMenu);
      _this = _super.call(this, {
        menuElement: menuElement,
        menuItemSelector: menuItemSelector,
        menuLinkSelector: menuLinkSelector,
      ...
      _defineProperty$6(_assertThisInitialized$c(_this), "_MenuType", Bootstrap4DisclosureMenu);
      _defineProperty$6(_assertThisInitialized$c(_this), "_MenuItemType", Bootstrap4DisclosureMenuItem);
      _defineProperty$6(_assertThisInitialized$c(_this), "_MenuToggleType", Bootstrap4DisclosureMenuToggle);
      if (initialize) {
        _this.initialize();
      }
      return _this;
    }
    return _createClass$c(Bootstrap4DisclosureMenu);
  }(DisclosureMenu);
  ...
  function _superPropBase$6(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf$b(object); if (object === null) break; } return object; }
  ...
  var MenubarItem = function (_BaseMenuItem) {
    _inherits$b(MenubarItem, _BaseMenuItem);
    var _super = _createSuper$b(MenubarItem);
    function MenubarItem(_ref) {
      ...
      var menuItemElement = _ref.menuItemElement,
          ...
          _ref$initialize = _ref.initialize,
          initialize = _ref$initialize === void 0 ? true : _ref$initialize;
      _classCallCheck$b(this, MenubarItem);
      _this = _super.call(this, {
        menuItemElement: menuItemElement,
        menuLinkElement: menuLinkElement,
        parentMenu: parentMenu,
    ...
    _createClass$b(MenubarItem, [{
      key: "initialize",
      value: function initialize() {
        _get$6(_getPrototypeOf$b(MenubarItem.prototype), "initialize", this).call(this);
      ...
      key: "focus",
      value: function focus() {
        _get$6(_getPrototypeOf$b(MenubarItem.prototype), "focus", this).call(this);
      ...
      key: "blur",
      value: function blur() {
        _get$6(_getPrototypeOf$b(MenubarItem.prototype), "blur", this).call(this);
        if (this.elements.parentMenu.isTopLevel) {
          this.dom.link.tabIndex = -1;
        }
      }
  ...
  function _superPropBase$5(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf$a(object); if (object === null) break; } return object; }
  ...
  var MenubarToggle = function (_BaseMenuToggle) {
    _inherits$a(MenubarToggle, _BaseMenuToggle);
    var _super = _createSuper$a(MenubarToggle);
    function MenubarToggle(_ref) {
      ...
      var menuToggleElement = _ref.menuToggleElement,
          ...
          _ref$initialize = _ref.initialize,
          initialize = _ref$initialize === void 0 ? true : _ref$initialize;
      _classCallCheck$a(this, MenubarToggle);
      _this = _super.call(this, {
        menuToggleElement: menuToggleElement,
        parentElement: parentElement,
        controlledMenu: controlledMenu,
    ...
    _createClass$a(MenubarToggle, [{
      key: "open",
      value: function open() {
        this.closeSiblings();
        _get$5(_getPrototypeOf$a(MenubarToggle.prototype), "open", this).call(this);
      }
    }, {
      key: "preview",
      value: function preview() {
        this.closeSiblings();
        _get$5(_getPrototypeOf$a(MenubarToggle.prototype), "preview", this).call(this);
      }
    }, {
      key: "close",
      value: function close() {
        ...
        _get$5(_getPrototypeOf$a(MenubarToggle.prototype), "close", this).call(this);
      }
    }]);
  ...
  function _superPropBase$4(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf$9(object); if (object === null) break; } return object; }
  ...
  var Menubar = function (_BaseMenu) {
    ...
    function Menubar(_ref) {
      ...
      var menuElement = _ref.menuElement,
          ...
          _ref$initialize = _ref.initialize,
          initialize = _ref$initialize === void 0 ? true : _ref$initialize;
      _classCallCheck$9(this, Menubar);
      _this = _super.call(this, {
        menuElement: menuElement,
        menuItemSelector: menuItemSelector,
        menuLinkSelector: menuLinkSelector,
      ...
      _defineProperty$5(_assertThisInitialized$9(_this), "_MenuType", Menubar);
      _defineProperty$5(_assertThisInitialized$9(_this), "_MenuItemType", MenubarItem);
      _defineProperty$5(_assertThisInitialized$9(_this), "_MenuToggleType", MenubarToggle);
      if (initialize) {
        _this.initialize();
      }
      return _this;
    }
    _createClass$9(Menubar, [{
      key: "initialize",
      value: function initialize() {
        try {
          _get$4(_getPrototypeOf$9(Menubar.prototype), "initialize", this).call(this);
      ...
      value: function _handleClick() {
        var _this2 = this;
        _get$4(_getPrototypeOf$9(Menubar.prototype), "_handleClick", this).call(this);
        document.addEventListener("pointerup", function (event) {
          if (_this2.focusState !== "none") {
            _this2.currentEvent = "mouse";
            if (!_this2.dom.menu.contains(event.target) && !_this2.dom.menu !== event.target) {
      ...
      value: function _handleKeydown() {
        var _this3 = this;
        _get$4(_getPrototypeOf$9(Menubar.prototype), "_handleKeydown", this).call(this);
        this.dom.menu.addEventListener("keydown", function (event) {
          _this3.currentEvent = "keyboard";
          var key = keyPress(event);
          if (key === "Tab") {
      ...
      value: function _handleKeyup() {
        var _this4 = this;
        _get$4(_getPrototypeOf$9(Menubar.prototype), "_handleKeyup", this).call(this);
        this.dom.menu.addEventListener("keyup", function (event) {
          _this4.currentEvent = "keyboard";
          var key = keyPress(event);
  ...
  var Bootstrap4MenubarItem = function (_MenubarItem) {
    _inherits$8(Bootstrap4MenubarItem, _MenubarItem);
    var _super = _createSuper$8(Bootstrap4MenubarItem);
    function Bootstrap4MenubarItem(_ref) {
      ...
      var menuItemElement = _ref.menuItemElement,
          ...
          _ref$initialize = _ref.initialize,
          initialize = _ref$initialize === void 0 ? true : _ref$initialize;
      _classCallCheck$8(this, Bootstrap4MenubarItem);
      _this = _super.call(this, {
        menuItemElement: menuItemElement,
        menuLinkElement: menuLinkElement,
        parentMenu: parentMenu,
    ...
    return _createClass$8(Bootstrap4MenubarItem);
  }(MenubarItem);
  ...
  function _superPropBase$3(object, property) { while (!Object.prototype.hasOwnProperty.call(object, property)) { object = _getPrototypeOf$7(object); if (object === null) break; } return object; }
  ...
  var Bootstrap4MenubarToggle = function (_MenubarToggle) {
    _inherits$7(Bootstrap4MenubarToggle, _MenubarToggle);
    var _super = _createSuper$7(Bootstrap4MenubarToggle);
    function Bootstrap4MenubarToggle(_ref) {
      ...
      var menuToggleElement = _ref.menuToggleElement,
          ...
          _ref$initialize = _ref.initialize,
          initialize = _ref$initialize === void 0 ? true : _ref$initialize;
      _classCallCheck$7(this, Bootstrap4MenubarToggle);
      _this = _super.call(this, {
        menuToggleElement: menuToggleElement,
        parentElement: parentElement,
        controlledMenu: controlledMenu,
      ...
      _defineProperty$4(_assertThisInitialized$7(_this), "_dom", {
        toggle: null,
        parent: null,
        container: null
      });
    ...
    _createClass$7(Bootstrap4MenubarToggle, [{
      key: "initialize",
      value: function initialize() {
        _get$3(_getPrototypeOf$7(Bootstrap4MenubarToggle.prototype), "initialize", this).call(this);
        if (this.dom.toggle.hasAttribute("data-toggle")) {
          this.dom.toggle.removeAttribute("data-toggle");
        }
        if (this.dom.toggle.hasAttribute("data-target")) {
  ...
  var Bootstrap4Menubar = function (_Menubar) {
    _inherits$6(Bootstrap4Menubar, _Menubar);
    var _super = _createSuper$6(Bootstrap4Menubar);
    function Bootstrap4Menubar(_ref) {
      ...
      var menuElement = _ref.menuElement,
          ...
          _ref$initialize = _ref.initialize,
          initialize = _ref$initialize === void 0 ? true : _ref$initialize;
      _classCallCheck$6(this, Bootstrap4Menubar);
      _this = _super.call(this, {
        menuElement: menuElement,
        menuItemSelector: menuItemSelector,
        menuLinkSelector: menuLinkSelector,
      ...
      _defineProperty$3(_assertThisInitialized$6(_this), "_MenuType", Bootstrap4Menubar);
      _defineProperty$3(_assertThisInitialized$6(_this), "_MenuItemType", Bootstrap4MenubarItem);
      _defineProperty$3(_assertThisInitialized$6(_this), "_MenuToggleType", Bootstrap4MenubarToggle);
      if (initialize) {
        _this.initialize();
      }
      return _this;
    }
    return _createClass$6(Bootstrap4Menubar);
  }(Menubar);
  ...
  var TreeviewToggle = function (_BaseMenuToggle) {
    ...
    return _createClass$4(TreeviewToggle);
  }(BaseMenuToggle);
  ...
  var Bootstrap4TreeviewItem = function (_TreeviewItem) {
    ...
    return _createClass$2(Bootstrap4TreeviewItem);
  }(TreeviewItem);
  ...
  var Bootstrap4TreeviewToggle = function (_TreeviewToggle) {
    ...
    _createClass$1(Bootstrap4TreeviewToggle, [{
      key: "initialize",
      value: function initialize() {
  ...
  var Bootstrap4Treeview = function (_Treeview) {
    ...
    function Bootstrap4Treeview(_ref) {
      ...
      _defineProperty(_assertThisInitialized(_this), "_MenuType", Bootstrap4Treeview);
      _defineProperty(_assertThisInitialized(_this), "_MenuItemType", Bootstrap4TreeviewItem);
      _defineProperty(_assertThisInitialized(_this), "_MenuToggleType", Bootstrap4TreeviewToggle);
      if (initialize) {
        _this.initialize();
      }
      return _this;
    }
    return _createClass(Bootstrap4Treeview);
  }(Treeview);
