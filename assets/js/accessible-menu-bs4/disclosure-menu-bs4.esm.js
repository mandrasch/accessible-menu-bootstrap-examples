...
var DisclosureMenuItem = function (_BaseMenuItem) {
  ...
  return _createClass$5(DisclosureMenuItem);
}(BaseMenuItem);
...
var DisclosureMenuToggle = function (_BaseMenuToggle) {
  ...
  _createClass$4(DisclosureMenuToggle, [{
    key: "open",
    value: function open() {
      this.closeSiblings();
...
var DisclosureMenu = function (_BaseMenu) {
  ...
  _createClass$3(DisclosureMenu, [{
    ...
    key: "_validate",
    value: function _validate() {
      var check = _get$1(_getPrototypeOf$3(DisclosureMenu.prototype), "_validate", this).call(this);
      if (!isValidType("boolean", {
    ...
    value: function _handleClick() {
      var _this2 = this;
      _get$1(_getPrototypeOf$3(DisclosureMenu.prototype), "_handleClick", this).call(this);
    ...
    value: function _handleKeydown() {
      var _this3 = this;
      _get$1(_getPrototypeOf$3(DisclosureMenu.prototype), "_handleKeydown", this).call(this);
    ...
    value: function _handleKeyup() {
      var _this4 = this;
      _get$1(_getPrototypeOf$3(DisclosureMenu.prototype), "_handleKeyup", this).call(this);
...
var Bootstrap4DisclosureMenuItem = function (_DisclosureMenuItem) {
  ...
  return _createClass$2(Bootstrap4DisclosureMenuItem);
}(DisclosureMenuItem);
...
var Bootstrap4DisclosureMenuToggle = function (_DisclosureMenuToggle) {
  ...
  _createClass$1(Bootstrap4DisclosureMenuToggle, [{
    key: "initialize",
    value: function initialize() {
...
var Bootstrap4DisclosureMenu = function (_DisclosureMenu) {
  ...
  return _createClass(Bootstrap4DisclosureMenu);
}(DisclosureMenu);

export { Bootstrap4DisclosureMenu as default };
